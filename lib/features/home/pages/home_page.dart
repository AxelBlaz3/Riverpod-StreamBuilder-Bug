...
import 'package:riverpod_streambuilder_bug/features/home/home_provider.dart';
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            const Text('Click on the FAB to add fake accounts to local DB. Clicking once is enough!'),
          ],
        ),
      ),
      floatingActionButton: FloatingActionButton.extended(
          onPressed: () async {
            await ref.read(homeProvider.notifier).saveFakeAccounts();
          },
